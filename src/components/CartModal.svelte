<div class="relative z-10" role="dialog" aria-modal="true">
  ...
  -->
  <div
    class="hidden sm:fixed sm:inset-0 sm:block sm:bg-gray-500/75 sm:transition-opacity"
    aria-hidden="true"
  ></div>
      ...
      >
        ...
        >
          ...
          <section aria-labelledby="cart-heading">
            ...
            >
              <li class="flex py-8 text-sm sm:items-center">
                <img
                  src="https://tailwindui.com/plus-assets/img/ecommerce-images/shopping-cart-page-04-product-03.jpg"
                ...
                >
                  ...
                  >
                    <div class="inline-grid w-full max-w-16 grid-cols-1">
                      <select
                        name="quantity-0"
                        aria-label="Quantity, Zip Tote Basket"
              ...
              <li class="flex py-8 text-sm sm:items-center">
                ...
                >
                  ...
                  <div
                    class="ml-4 grid flex-auto grid-cols-1 grid-rows-1 items-end gap-x-5 gap-y-3 sm:ml-6 sm:flex sm:items-center sm:gap-0"
                  >
                    <p
                    ...
                    <button
                      type="button"
                      class="ml-4 font-medium text-indigo-600 hover:text-indigo-500 sm:mt-2 sm:ml-0"
                    >
                      <span>Remove</span>
                    </button>
                  </div>
          ...
          <div class="mt-8 flex justify-end px-4 sm:px-6 lg:px-8">
            <button
              type="submit"
              class="rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden"
